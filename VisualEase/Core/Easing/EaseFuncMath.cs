 ...
 * 
 * Code of easing function copied from http://wpf-animation.googlecode.com/svn/trunk/src/WPF/Animation/PennerDoubleAnimation.cs .
 * 
...
namespace f14.VisualEase.Core.Easing
{
    public sealed class EaseFuncMath
    {
        ...
        /// <param name="d">Duration of animation.</param>
        /// <returns>The correct value.</returns>
        public static double CircleEaseOut(double t, double b, double c, double d)
        {
        ...
        /// <param name="d">Duration of animation.</param>
        /// <returns>The correct value.</returns>
        public static double CircleEaseIn(double t, double b, double c, double d)
        {
        ...
        /// <param name="d">Duration of animation.</param>
        /// <returns>The correct value.</returns>
        public static double CircleEaseInOut(double t, double b, double c, double d)
        {
            if ((t /= d / 2) < 1)
        ...
        /// <param name="d">Duration of animation.</param>
        /// <returns>The correct value.</returns>
        public static double CircleEaseOutIn(double t, double b, double c, double d)
        {
            if (t < d / 2)
                return CircleEaseOut(t * 2, b, c / 2, d);
